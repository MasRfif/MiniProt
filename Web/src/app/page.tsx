...
export default function Home() {
  return (
    <>
      <section id="hero" className="w-full h-screen bg-cover" style={{ backgroundImage: "url(./LandingPage.jpg)" }}>
        <div>
            ...
            <div className="text-2xl md:text-4xl z-40 font-bold text-white">
              <div className="w-full h-full px-5 md:pl-10 flex justify-start items-center">
                <div className="text-left">
                  <h1 className="text-4xl md:text-6xl pb-4 font-extrabold">Welcome To</h1>
                  <div className="flex items-center">
                    <span className="text-4xl md:text-6xl font-bold">Event</span>
                    <Logo className="mx-3" />
                    <span className="text-4xl md:text-6xl font-bold">Occasion</span>
                  </div>
                  <p className="text-sm md:text-lg pt-10 font-light">
                    Welcome to Evnet Occasion, your ultimate destination for finding exciting Japanese events across Indonesia. Whether you are a fan of traditional festivals, modern pop culture, or culinary delights, we bring you the best
